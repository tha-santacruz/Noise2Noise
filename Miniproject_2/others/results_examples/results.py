...
if __name__ == '__main__':
    ...
    # data demo
    Model = importlib.import_module("Miniproject_2.model").Model
    model = Model()
    model.load_pretrained_model(model_name= "bestmodel.pkl")
    ...
    for i in range(20):
        ...
        f.tight_layout()
        f.savefig(f"results_2/results{i}.png", bbox_inches = 'tight', pad_inches = 0)
